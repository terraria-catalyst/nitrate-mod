...
internal sealed class Vector2Simdifier : AbstractSimdifier
{
    ...
    private static FnaVector2 op_Multiply_Vector2_int(FnaVector2 @this, float value) => As(As(@this) * value);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static FnaVector2 op_Multiply_Vector2_Vector2(FnaVector2 @this, FnaVector2 value) => As(As(@this) * As(value));

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static FnaVector2 op_Addition_Vector2_Vector2(FnaVector2 @this, FnaVector2 value) => As(As(@this) + As(value));

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static FnaVector2 op_Subtraction_Vector2_Vector2(FnaVector2 @this, FnaVector2 value) => As(As(@this) - As(value));

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static FnaVector2 op_Division_Vector2_float(FnaVector2 @this, float value) => As(As(@this) / value);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static FnaVector2 op_Division_Vector2_Vector2(FnaVector2 @this, FnaVector2 value) => As(As(@this) / As(value));
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static FnaVector2 As(SimdVector2 value) => Unsafe.As<SimdVector2, FnaVector2>(ref value);
}