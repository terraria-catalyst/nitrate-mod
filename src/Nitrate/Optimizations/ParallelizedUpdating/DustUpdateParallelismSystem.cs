...
{
    private static readonly MethodInfo update_dust_filler = Info.OfMethod("Nitrate", "Nitrate.Optimizations.DustUpdateParallelismSystem", "UpdateDustFiller");
    private static readonly MethodInfo inner_update_dust = Info.OfMethod("Nitrate", "Nitrate.Optimizations.DustUpdateParallelismSystem", "InnerUpdateDust");
