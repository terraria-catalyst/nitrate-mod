...
namespace Terraria.ModLoader.Setup
{
	public class PatchTask : SetupOperation
	{
		...
		public static IEnumerable<(string file, string relPath)> EnumerateSrcFiles(string dir) => EnumerateFiles(dir).Where(f => !f.relPath.Split('/', '\\').Any(nonSourceDirs.Contains));
